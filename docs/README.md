...
| [svelte-preview-plan.md](svelte-preview-plan.md) | Plan for a rendered page-builder preview of this Svelte site inside the Pages CMS fork — why a Svelte renderer can't be dropped in, and the proxy design that works |
